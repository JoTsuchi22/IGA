...
#         for i in range(l[0]):
#            CP_2d1w, l[0], m[0], knot_i = knot_insertion_A(CP_2d1w[], n[0], l[0], m[0], knot_i, new_knot_position)
#     if insert_parameter_axis == 1:
#         for j in range(l[1]):
#            CP_2d1w, l[1], m[1], knot_j = knot_insertion_A(CP_2d1w[], n[1], l[1], m[1], knot_j, new_knot_position)
...
#         new_knot_position = new_knot_position[1:-1]
#         CP_2d1w, l, m, knot_i, knot_j = knot_insertion_A_2p2d1w(CP_2d1w, n, l, m, knot_i, knot_j, insert_parameter_axis, new_knot_position)
#     return CP_2d1w, l, m, knot_i, knot_j
...
# def knot_insertion_A_1p1d():


# def knot_insertion_B_1p1d():


# def knot_insertion_C_1p1d():

...
for i in range(delta[0]):
    for j in range(delta[1]):
        ...
        Sx_vec[i][j] = Sx
        Sy_vec[i][j] = Sy
# ax1.plot(Sx_vec[0], Sy_vec[0], c=color[0], marker="", linewidth=0.7)
# ax1.plot(Sx_vec[25], Sy_vec[25], c=color[0], marker="", linewidth=0.7)
# ax1.plot(Sx_vec[-1], Sy_vec[-1], c=color[0], marker="", linewidth=0.7)
# ax1.plot(Sx_vec.T[0], Sy_vec.T[0], c=color[0], marker="", linewidth=0.7)
# ax1.plot(Sx_vec.T[-1], Sy_vec.T[-1], c=color[0], marker="", linewidth=0.7)

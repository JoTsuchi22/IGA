...
patch[num,:patch_info[num][0]*patch_info[num][1],:] = np.array(
   [[1.0000000000000000e+00,	0.0000000000000000e+00,	1.0000000000000000e+00],
    [2.5000000000000004e+00,	0.0000000000000000e+00,	1.0000000000000000e+00],
    ...
    [1.0000000000000000e+00,	2.6876110206469050e-01,	9.4925302167419123e-01],
    [2.5000000000000009e+00,	7.7395020754913291e-01,	9.4925302167419123e-01],
    [4.0000000000000000e+00,	1.2791393130335753e+00,	9.4925302167419123e-01],
    [5.5000000000000000e+00,	1.7843284185180177e+00,	9.4925302167419123e-01],
    [8.9714957897566006e-01,	5.1706398339743509e-01,	9.4925302167419112e-01],
    [2.4314330526504406e+00,	1.5832665160922841e+00,	9.4925302167419112e-01],
    [3.9657165263252199e+00,	2.6494690487871333e+00,	9.4925302167419112e-01],
    [5.5000000000000009e+00,	3.7156715814819825e+00,	9.4925302167419112e-01],
    [7.0710678118654757e-01,	7.0710678118654757e-01,	1.0000000000000000e+00],
    [2.3047378541243653e+00,	2.3047378541243653e+00,	1.0000000000000000e+00],
    [3.9023689270621826e+00,	3.9023689270621826e+00,	1.0000000000000000e+00],
    [5.5000000000000000e+00,	5.5000000000000000e+00,	1.0000000000000000e+00]])

num = 1
patch[num,:patch_info[num][0]*patch_info[num][1],:] = np.array(
   [[5.5000000000000000e+00,	0.0000000000000000e+00,	1.0000000000000000e+00],
    [7.0000000000000000e+00,	0.0000000000000000e+00,	1.0000000000000000e+00],
    [8.5000000000000000e+00,	0.0000000000000000e+00,	1.0000000000000000e+00],
    [1.0000000000000000e+01,	0.0000000000000000e+00,	1.0000000000000000e+00],
    [5.5000000000000000e+00,	1.8333333333333335e+00,	1.0000000000000000e+00],
    [7.0000000000000000e+00,	1.8333333333333335e+00,	1.0000000000000000e+00],
    [8.5000000000000000e+00,	1.8333333333333335e+00,	1.0000000000000000e+00],
    [1.0000000000000000e+01,	1.8333333333333335e+00,	1.0000000000000000e+00],
    [5.5000000000000000e+00,	3.6666666666666670e+00,	1.0000000000000000e+00],
    [7.0000000000000000e+00,	3.6666666666666670e+00,	1.0000000000000000e+00],
    [8.5000000000000000e+00,	3.6666666666666670e+00,	1.0000000000000000e+00],
    [1.0000000000000000e+01,	3.6666666666666670e+00,	1.0000000000000000e+00],
    [5.5000000000000000e+00,	5.5000000000000000e+00,	1.0000000000000000e+00],
    [7.0000000000000000e+00,	5.5000000000000000e+00,	1.0000000000000000e+00],
    [8.5000000000000000e+00,	5.5000000000000000e+00,	1.0000000000000000e+00],
...
patch[num,:patch_info[num][0]*patch_info[num][1],:] = np.array(
   [[5.5000000000000000e+00,	5.5000000000000000e+00,	1.0000000000000000e+00],
    ...
    [8.5000000000000000e+00,	5.5000000000000000e+00,	1.0000000000000000e+00],
    [1.0000000000000000e+01,	5.5000000000000000e+00,	1.0000000000000000e+00],
    [5.5000000000000000e+00,	7.0000000000000000e+00,	1.0000000000000000e+00],
    [7.0000000000000000e+00,	7.0000000000000000e+00,	1.0000000000000000e+00],
    [8.5000000000000000e+00,	7.0000000000000000e+00,	1.0000000000000000e+00],
    [1.0000000000000000e+01,	7.0000000000000000e+00,	1.0000000000000000e+00],
    [5.5000000000000000e+00,	8.5000000000000000e+00,	1.0000000000000000e+00],
    [7.0000000000000000e+00,	8.5000000000000000e+00,	1.0000000000000000e+00],
    [8.5000000000000000e+00,	8.5000000000000000e+00,	1.0000000000000000e+00],
    [1.0000000000000000e+01,	8.5000000000000000e+00,	1.0000000000000000e+00],
    [5.5000000000000000e+00,	1.0000000000000000e+01,	1.0000000000000000e+00],
    [7.0000000000000000e+00,	1.0000000000000000e+01,	1.0000000000000000e+00],
    [8.5000000000000000e+00,	1.0000000000000000e+01,	1.0000000000000000e+00],
...
patch[num,:patch_info[num][0]*patch_info[num][1],:] = np.array(
   [[0.0000000000000000e+00,	5.5000000000000000e+00,	1.0000000000000000e+00],
    [1.8333333333333335e+00,	5.5000000000000000e+00,	1.0000000000000000e+00],
    [3.6666666666666670e+00,	5.5000000000000000e+00,	1.0000000000000000e+00],
    [5.5000000000000000e+00,	5.5000000000000000e+00,	1.0000000000000000e+00],
    [0.0000000000000000e+00,	7.0000000000000000e+00,	1.0000000000000000e+00],
    [1.8333333333333337e+00,	7.0000000000000000e+00,	1.0000000000000000e+00],
    [3.6666666666666674e+00,	7.0000000000000000e+00,	1.0000000000000000e+00],
    [5.5000000000000000e+00,	7.0000000000000000e+00,	1.0000000000000000e+00],
    [0.0000000000000000e+00,	8.5000000000000000e+00,	1.0000000000000000e+00],
    [1.8333333333333335e+00,	8.5000000000000000e+00,	1.0000000000000000e+00],
    [3.6666666666666670e+00,	8.5000000000000000e+00,	1.0000000000000000e+00],
    [5.5000000000000000e+00,	8.5000000000000000e+00,	1.0000000000000000e+00],
    [0.0000000000000000e+00,	1.0000000000000000e+01,	1.0000000000000000e+00],
    [1.8333333333333335e+00,	1.0000000000000000e+01,	1.0000000000000000e+00],
    [3.6666666666666670e+00,	1.0000000000000000e+01,	1.0000000000000000e+00],
    [5.5000000000000000e+00,	1.0000000000000000e+01,	1.0000000000000000e+00]])
...
patch[num,:patch_info[num][0]*patch_info[num][1],:] = np.array(
   [[7.0710678118654757e-01,	7.0710678118654757e-01,	1.0000000000000000e+00],
    ...
    [3.9023689270621826e+00,	3.9023689270621826e+00,	1.0000000000000000e+00],
    [5.5000000000000000e+00,	5.5000000000000000e+00,	1.0000000000000000e+00],
    [5.1706398339743498e-01,	8.9714957897565994e-01,	9.4925302167419123e-01],
    [1.5832665160922841e+00,	2.4314330526504406e+00,	9.4925302167419123e-01],
    [2.6494690487871333e+00,	3.9657165263252199e+00,	9.4925302167419123e-01],
    [3.7156715814819821e+00,	5.5000000000000000e+00,	9.4925302167419123e-01],
    [2.6876110206469045e-01,	1.0000000000000000e+00,	9.4925302167419112e-01],
    [7.7395020754913291e-01,	2.5000000000000004e+00,	9.4925302167419112e-01],
    [1.2791393130335751e+00,	4.0000000000000000e+00,	9.4925302167419112e-01],
    [1.7843284185180177e+00,	5.5000000000000009e+00,	9.4925302167419112e-01],
    [0.0000000000000000e+00,	1.0000000000000000e+00,	1.0000000000000000e+00],
    [0.0000000000000000e+00,	2.5000000000000004e+00,	1.0000000000000000e+00],
